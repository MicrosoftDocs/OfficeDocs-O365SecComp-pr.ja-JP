...
**概要**office 365 のグローバル管理者であり、組織に[office 365 の脅威インテリジェンス](office-365-ti.md)がある場合は、攻撃シミュレータを使用して、組織内で現実的な攻撃シナリオを実行できます。これは、実際の攻撃が下の回線に影響を与える前に、脆弱性のあるユーザーを特定して見つけるのに役立ちます。詳細については、この記事をお読みください。
...
- 組織が[Office 365 ユーザーに多要素認証](https://docs.microsoft.com/office365/admin/security-and-compliance/set-up-multi-factor-authentication?view=o365-worldwide)を使用している
...
アタックシミュレータに新機能が追加されています。次のようなものがあります。
