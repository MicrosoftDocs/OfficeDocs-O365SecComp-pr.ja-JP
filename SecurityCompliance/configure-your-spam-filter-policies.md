...
2. [**スパム対策設定**] ページで、次のいずれかの手順を実行します。 
      ...
      - [**カスタム**] タブをクリックし、[**カスタム設定**] セレクターを **[オン**] に変更し![、[](media/ITPro-EAC-AddIcon.gif) * * 追加] [**ポリシーの作成**] ボタンをクリックして、ユーザー、グループ、およびユーザーに適用可能な新しいカスタムスパムフィルターポリシーを作成します。と組織内のドメイン。また、既存のカスタムポリシーをダブルクリックして編集することもできます。 
