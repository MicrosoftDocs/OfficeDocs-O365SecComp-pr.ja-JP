...
## [セキュリティ強化のために、Office 365 テナントを設定する](tenant-wide-setup-for-increased-security.md)
...
## [無料の Azure Active Directory Domain Services サブスクリプションを使用する](use-your-free-azure-ad-subscription-in-office-365.md)
...
### [機密ラベルの暗号化を使用してコンテンツへのアクセスを制限する](encryption-sensitivity-labels.md)
### [機密ラベルをコンテンツに自動適用する](apply_sensitivity_label_automatically.md)
### [ラベル分析によるラベル使用状況の表示](label-analytics.md)
## [データ損失の防止 (DLP)](data-loss-prevention-policies.md)
### [DLP についてもっと詳しく見る](https://channel9.msdn.com/events/ignite/microsoft-ignite-orlando-2017/brk3111)
## DLP を設定する
### [DLP のポリシー勧告を見る](get-started-with-dlp-policy-recommendations.md)
### [既定の DLP ポリシーの使用を開始する](get-started-with-the-default-dlp-policy.md)
...
### [DLP のカスタマイズについてもっと詳しく見る](https://go.microsoft.com/fwlink/?linkid=852306)
...
### [Office 365 セキュリティ/コンプライアンス センター の PowerShell でカスタムの機密情報の種類を作成する](create-a-custom-sensitive-information-type-in-scc-powershell.md)
### [キーワード 辞書を作成する](create-a-keyword-dictionary.md)
### [ドキュメント フィンガープリンティング](document-fingerprinting.md)

# レコード管理
## [保持ポリシー](retention-policies.md)
## [保持ラベル](labels.md)
## [Exchange Online および セキュリティ/コンプライアンス センターを使用して米国証券取引委員会規則 17a-4 (SEC Rule 17a-4) に準拠する](use-exchange-online-to-comply-with-sec-rule-17a-4.md)
## [廃棄確認](disposition-reviews.md)
## [イベント ドリブンの保持](event-driven-retention.md)
## [イベント ベースの保持の自動化](automate-event-driven-retention.md)
## [ファイル計画マネージャー](file-plan-manager.md)
## [PowerShell を使用して保持ラベルを一括で作成および発行する](https://docs.microsoft.com/en-us/office365/securitycompliance/bulk-create-publish-labels-using-powershell)

# データ ガバナンスを管理する
## [データのインポート](importing-pst-files-to-office-365.md)
...
### [無制限アーカイブの有効化](enable-unlimited-archiving.md)
...
### [組織の監督ポリシーを設定する](configure-supervision-policies.md)
...
## データ ガバナンスをモニターする
### [ドキュメントのラベル アクティビティを表示する](view-label-activity-for-documents.md)
### [ラベル分析によるラベル使用状況の表示](label-analytics.md)
...
# [脅威から保護する](protect-against-threats.md)
...
### [クイック スタート ガイド: Office 365 ATP を設定する](checklist-atp-setup.md)
#### [Integrate Office 365 ATP と Windows Defender Advanced Threat Protection の統合](integrate-office-365-ti-with-wdatp.md)
#### [SIEM と Office 365 ATP の統合](siem-integration-with-office-365-ti.md)
### [ATP の安全なリンク機能](atp-safe-links.md)
...
#### [Dynamic Delivery (動的配信)とプレビュー](dynamic-delivery-and-previewing.md)
...
#### [脅威エクスプローラー ビュー](threat-explorer-views.md)
...
### [Office 365 でメールが迷惑メールとしてマークされるのを防ぐ方法](prevent-email-from-being-marked-as-spam.md)
...
### [ゼロアワー自動消去 - スパムまたはマルウェアからの保護](zero-hour-auto-purge.md)
### [スパムが各ユーザーの 迷惑メール フォルダーに転送されるようにする](ensure-that-spam-is-routed-to-each-user-s-junk-email-folder.md)
### [迷惑メール メッセージを Microsoft に報告する](report-junk-email-messages-to-microsoft.md)
### [バルク メーラーの差出人セーフ リストを管理する](manage-safe-sender-lists-for-bulk-mailers.md)
### [マルウェア対策ポリシーを設定する](configure-anti-malware-policies.md)
### [スパム対策ポリシーを設定する](configure-the-anti-spam-policies.md)
### [Office 365 で組織全体の信頼できる差出人またはブロックする差出人のリストを作成する](create-organization-wide-safe-sender-or-blocked-sender-lists-in-office-365.md)
### [スパム フィルター ポリシーの設定](configure-your-spam-filter-policies.md)
### [接続フィルター ポリシーを設定する](configure-the-connection-filter-policy.md)
### [送信スパム ポリシーを設定する](configure-the-outbound-spam-policy.md)
...
#### [無効化ポータルを使って、Office 365 の受信拒否リストから自分自身を削除する](use-the-delist-portal-to-remove-yourself-from-the-office-365-blocked-senders-lis.md)
#### [スパム対策メッセージ ヘッダー](anti-spam-message-headers.md)
### メールの検証と認証
#### [Office 365 で SPF を使用して、スプーフィングを防止する方法](how-office-365-uses-spf-to-prevent-spoofing.md)
#### [Office 365 で SPF を設定して、スプーフィングを防止する](set-up-spf-in-office-365-to-help-prevent-spoofing.md)
...
### [Office 365 のフィッシング対策保護](anti-phishing-protection.md)
#### [Office 365 の ATP フィッシング対策機能](atp-anti-phishing.md)
#### [フィッシング対策および ATP フィッシング対策ポリシーを設定する](set-up-anti-phishing-policies.md)
#### [Office 365 がフィッシング詐欺を防ぐために差出人アドレスを検証する方法](how-office-365-validates-the-from-address.md)
### [Office 365 のスプーフィング対策保護](anti-spoofing-protection.md)
#### [スプーフィング インテリジェンスをもっとよく知る](learn-about-spoof-intelligence.md)

## [Office 365 の暗号化](encryption.md)
### [Office 365 Enterprise で暗号化を設定する](set-up-encryption.md)
### [Office 365 の電子メールの暗号化](email-encryption.md)
...
#### [Office 365 でメール メッセージを暗号化するためにメール フロー ルールを定義する](define-mail-flow-rules-to-encrypt-email.md)
...
#### [Office 365 Message Encryption によって暗号化された電子メールを無効にする](revoke-ome-encrypted-mail.md)
#### [暗号化されたメッセージに組織のブランドを追加する](add-your-organization-brand-to-encrypted-messages.md)
#### [Office 365 Message Encryption の古い情報](legacy-information-for-message-encryption.md)
...
#### [IRM を設定して、オンプレミスの AD RMS サーバーを使用する](configure-irm-to-use-an-on-premises-ad-rms-server.md)
### [S/MIME](s-mime-for-message-signing-and-encryption.md)
#### [S/MIME によるメッセージの署名と暗号化](s-mime-for-message-signing-and-encryption.md)
#### [Outlook on the web の S/MIME を設定する](configure-s-mime-settings-for-outlook-web-app.md)
#### [S/MIME で署名および暗号化された電子メールを送受信する](send-and-receive-s-mime-signed-and-encrypted-email.md)
#### [S/MIME 用にユーザー証明書を Office 365 に同期する](sync-user-certificates-to-office-365-for-s-mime.md)
...
### [Office 365 のFAQための、顧客キーによるサービスの暗号化](service-encryption-with-customer-key-faq.md)
### [Office 365 の暗号化についてのテクニカル リファレンスの詳細](technical-reference-details-about-encryption.md)
### [Office 365 で電子メール接続をセキュリティで保護するために、Exchange Online が TLS を使用する方法](exchange-online-uses-tls-to-secure-email-connections.md)

### [Microsoft Cloud における暗号化](office-365-encryption-in-the-microsoft-cloud-overview.md)
...
#### [Skype for Business、OneDrive for Business、SharePoint Online、Exchange Online の暗号化](office-365-encryption-for-skype-onedrive-sharepoint-and-exchange.md)
...
## [Office 365 Cloud App Security を使用してデータ アクセスを監視および管理する](office-365-cas-overview.md)
### [Cloud App Security の新機能を確認する](new-in-office-365-cas.md)
#### [2018 年の更新プログラム](new-in-office-365-cas-2018.md)
#### [2017 年の更新プログラム](new-in-office-365-cas-2017.md)
### [Office 365 Cloud App Security の使用の準備](get-ready-for-office-365-cas.md)
...
#### [Office 365 Cloud App Security のアプリの条件付きアクセス制御を使用してアプリを保護する](ocas-conditional-access-app-control.md)
##### [Office 365 アプリ用のアプリの条件付きアクセス制御を展開する](ocas-deploy-conditional-access-app-control.md)
##### [Office 365 Cloud App Security のセッション ポリシー](ocas-session-policies.md)
##### [Office 365 Cloud App Security のアクセス ポリシー](ocas-access-policies.md)
...
### [Office 365 Cloud App Security 展開後の利用方法](utilization-activities-for-ocas.md)
...
#### [Office 365 Cloud App Security の ウェブ トラフィック ログとデータ ソース](web-traffic-logs-and-data-sources-for-ocas.md)
#### [Office 365 Cloud App Security でユーザー アカウントを停止または復元する](suspend-or-restore-an-account-in-ocas.md)
### [Office 365 Cloud App Security を使用して アプリ 検出 レポートを作成する](create-app-discovery-reports-in-ocas.md)
...
### [ユーザーとして検疫済みメッセージを検索して解放する](find-and-release-quarantined-messages-as-a-user.md)
### [Office 365 の検疫に関する FAQ](quarantine-faq.md)
### [Office 365 でユーザーのスパム通知を使って検疫済みメッセージを解放して報告する](use-spam-notifications-to-release-and-report-quarantined-messages.md)
## [特権アクセス管理](privileged-access-management-overview.md)
### [特権アクセス管理を設定する](privileged-access-management-configuration.md)
...
### [コンテンツ検索結果のキーワード統計の表示](view-keyword-statistics-for-content-search.md)
...
### [ID リスト コンテンツ検索用の CSV ファイルを準備する](csv-file-for-an-id-list-content-search.md)
### [コンテンツ検索を使用してサード パーティのデータを検索する](use-content-search-to-search-third-party-data-that-was-imported.md)
### [電子情報開示ワークフローでコンテンツ検索を使用する](use-content-search-in-ediscovery.md)
### [コンテンツ検索クエリでエラーを確認する](check-your-content-search-query-for-errors.md)
### [コンテンツ検索用に Bcc 受信者を保持する](https://docs.microsoft.com/exchange/policy-and-compliance/holds/preserve-bcc-recipients-and-group-members)
## コンテンツ検索について理解する
...
### [電子情報開示検索結果での重複排除](de-duplication-in-ediscovery-search-results.md)
### [推定されるコンテンツ検索と実際のコンテンツ検索結果の違い](differences-between-estimated-and-actual-ediscovery-search-results.md)
## コンテンツ検索を構成する
### [コンテンツ検索用にアクセス許可フィルターを設定する](permissions-filtering-for-content-search.md)
...
### [コンテンツ検索を使用してメールボックスと OneDrive for Business サイトでユーザーのリストを探す](search-the-mailbox-and-onedrive-for-business-for-a-list-of-users.md)
### [複数のコンテンツ検索の作成、報告、削除](create-report-on-and-delete-multiple-content-searches.md)
### [コンテンツ検索をコピーする](clone-a-content-search.md)

# [法的調査を管理する](manage-legal-investigations.md)
## [電子情報開示ケースの作成と管理](ediscovery-cases.md)
## [電子情報開示のアクセス許可を指定する](assign-ediscovery-permissions.md)
...
## 保留リストを管理する
### [電子情報開示保留リストを作成する](ediscovery-cases.md#step-4-place-content-locations-on-hold)
...
### [保留中のメールボックスの回復可能なアイテムのクォータを拡大する](increase-the-recoverable-quota-for-mailboxes-on-hold.md)
### [Exchange Online メールボックスに保存されている保留の種類を特定する方法](identify-a-hold-on-an-exchange-online-mailbox.md)

## [Microsoft 365 の Advanced eDiscovery (プレビュー)](compliance20/overview-ediscovery-20.md)
### [ノートをリリースする](compliance20/release-notes-ediscovery20.md)
### [新しいケースを作成する](compliance20/create-new-ediscovery-case.md)

### [カストディアンと作業する](compliance20/managing-custodians.md)
#### [カストディアンをケースに追加する](compliance20/add-custodians-to-case.md)
...
#### [電子メールスレッド](compliance20/email-threading.md)
#### [テーマ](compliance20/themes.md)
#### [関連モジュールを使用したデータ分析](compliance20/using-relevance.md)
...
### [ケース設定を構成する](compliance20/configuring-case-settings-ediscovery20.md)
#### [ケースを閉じるか、ケースを削除する](compliance20/close-or-delete-case.md)
#### [ケースからメンバーを追加または削除する](compliance20/add-remove-members.md)
...
### [ケースを設定する](set-up-users-and-cases-in-advanced-ediscovery.md)
#### [ケースの問題を定義する](define-issues-and-assign-users.md)

### ケース データの収集
#### [Advanced eDiscovery 用のデータを作成する](prepare-data-for-advanced-ediscovery.md)
...
#### [プロセス モジュールを実行し、データを読み込む](run-the-process-module-and-load-data-in-advanced-ediscovery.md)
...
#### [ドキュメントの類似性 (準重複) についての概要](understand-document-similarity-in-advanced-ediscovery.md)
#### [分析結果を表示する](view-analyze-results-in-advanced-ediscovery.md)

### [関連モジュールの使用](use-relevance-in-advanced-ediscovery.md)
#### [関連評価の概要](assessment-in-relevance-in-advanced-ediscovery.md)
#### [関連評価の実行とタグ付け](tagging-and-assessment-in-advanced-ediscovery.md)
#### [関連トレーニングの設定](manage-relevance-setup-in-advanced-ediscovery.md)
#### [関連トレーニングの実行とタグ付け](tagging-and-relevance-training-in-advanced-ediscovery.md)
#### [関連トレーニング プロセスを追跡する](track-relevance-analysis-in-advanced-ediscovery.md)
#### [関連分析の結果をテストする](test-relevance-analysis-in-advanced-ediscovery.md)
#### [関連トレーニングの追加データを読み込む](set-up-loads-to-add-imported-files.md)

### [ケース データのエクスポート](export-case-data-in-advanced-ediscovery.md)
#### [データのエクスポート](export-results-in-advanced-ediscovery.md)
#### [レポートのフィールドのエクスポート](export-report-fields-in-advanced-ediscovery.md)
...
#### [Ignore Text 設定を構成する](set-ignore-text-in-advanced-ediscovery.md)
#### [協調表示されたキーワードとその他の関連設定を構成する](define-highlighted-keywords-and-advanced-options.md)

### Advanced eDiscovery の参照
#### [Advanced eDiscovery ユーティリティを使用する](use-advanced-ediscovery-utilities.md)
#### [レポートを実行する](run-reports-in-advanced-ediscovery.md)

# [データ調査を管理する](datainvestigations/overview-data-investigations.md)
## [ノートをリリースする](datainvestigations/data-investigations-release-notes.md)
## [データ流出インシデントを管理する](datainvestigations/manage-data-spillage-incidents.md)
## [新しい調査を作成する](datainvestigations/create-new-investigation.md)
 
## [調査でデータ検索する](datainvestigations/search-for-data.md)
...
### [Office 365 以外のデータを読み込む](datainvestigations/load-non-office365-data.md)
### [データ処理中のエラー修復](datainvestigations/error-remediation.md)

## [アナリティクスを使用して、より速い調査を実行する](datainvestigations/run-analytics-to-investigate-faster.md)
### [電子メールスレッド](datainvestigations/email-threading.md)
### [準重複の検出](datainvestigations/near-duplicates.md)
### [テーマ](datainvestigations/themes.md)
### [関連モジュールを実行する](datainvestigations/use-relevance-module.md)

## [調査に関心のあるユーザーを管理する](datainvestigations/manage-people-of-interest.md)
### [調査でユーザーのデータに索引を付ける](datainvestigations/index-data-people-of-interest.md)
### [調査中のユーザーの監査活動を表示する](datainvestigations/view-people-of-interest-activity.md)

## [調査データをエクスポートする](datainvestigations/export-data.md)
### [エビデンスから文書をエクスポートする](datainvestigations/export-documents-from-incident.md)
### [エクスポート ジョブのダウンロード](datainvestigations/download-export-jobs.md)

## [データ調査を設定する](datainvestigations/configure-settings-datainvestigations.md)
### [調査のメンバーを追加または削除する](datainvestigations/add-remove-members.md)
### [検索と分析の設定を構成する](datainvestigations/configure-search-analytics-settings.md)
### [調査を完了するか調査を削除する](datainvestigations/close-or-delete-investigation.md)
...
### [Microsoft 365 セキュリティ センター でのデバイスの監視](monitor-devices.md)
### [Microsoft 365 セキュリティ センターでのアプリの監視](monitor-apps.md)
## [ポリシーを通知する](alert-policies.md)
...
### [ウォークスルー - 詳細レポートからインサイトへの移動](from-a-detailed-report-to-an-insight.md)
### [ウォークスルー - インサイトから詳細レポートへの移動](from-an-insight-to-a-detailed-report.md)
### [ウォークスルー - ダッシュボードからインサイトへの移動](from-a-dashboard-to-an-insight.md)
...
## [セキュリティ/コンプライアンス センター のメッセージ追跡](message-trace-scc.md)
## [セキュリティ/コンプライアンス センター のメール フロー インサイト](mail-flow-insights.md)
### [自動転送済みメッセージレポート](mfi-auto-forwarded-messages-report.md)
### [メール ループのインサイト](mfi-mail-loop-insight.md)
### [送信と受信のメール フロー](mfi-outbound-and-inbound-mail-flow.md)
### [キューのアラートとキュー](mfi-queue-alerts-and-queues.md)
### [低速メール フローのルールのインサイト](mfi-slow-mail-flow-rules-insight.md)
...
### [選挙運動の開発/テスト環境用にグループとユーザーを作成する](configure-groups-and-users-for-a-political-campaign-dev-test-environment.md)
...
## [SIEM サーバーの統合](siem-server-integration.md)
...
## [オンプレミス Office サーバーでの GDPR 対応](gdpr-for-office-servers.md)
### [SharePoint Server での GDPR 対応](gdpr-for-sharepoint-server.md)
### [Exchange Server での GDPR 対応](gdpr-for-exchange-server.md)
### [Skype for Business Server および Lync Server での GDPR 対応](gdpr-for-skype-for-business-server.md)
### [Project Server での GDPR 対応](gdpr-for-project-server.md)
### [Office Web Apps Server および Office Online Server の GDPR 対応](gdpr-for-office-online-server.md)
### [オンプレミスの Windows Server ファイル共有の GDPR 対応](gdpr-for-on-premises-file-shares.md)
...
# サービス アシュアランス
## [Office 365 セキュリティ/コンプライアンス センター でのサービス アシュアランス](service-assurance.md)
## [Office 365 でのテナントの分離](office-365-tenant-isolation-overview.md)
### [Azure Active Directory Domain Services での分離とアクセス制御](office-365-isolation-in-azure-active-directory.md)
...
### [Office 365 検索でのテナントの分離](office-365-isolation-in-office-365-search.md)
### [Office 365 ビデオ でのテナントの分離](office-365-isolation-in-office-365-video.md)
### [Office Graph と Delve でのテナントの分離](office-365-isolation-in-graph-and-delve.md)
## [Office 365 でのデータの回復](office-365-data-resiliency-overview.md)
### [データの破損の対処](office-365-dealing-with-data-corruption.md)
### [Exchange Online データの回復](office-365-exchange-data-resiliency.md)
### [マルウェアと ランサムウェアからの保護](office-365-malware-and-ransomware-protection.md)
### [監視と自己修復](office-365-monitoring-and-self-healing.md)
### [SharePoint Online データの回復](office-365-sharepoint-data-resiliency.md)
...
### [Exchange Online データの削除](office-365-exchange-online-data-deletion.md)
### [SharePoint Online データの削除](office-365-sharepoint-online-data-deletion.md)
### [Skype for Business データの削除](office-365-skype-data-deletion.md)
...
### [Office 365 のエンジニアリングのための内部データログ](office-365-internal-logging.md)
...
### [EOP を設定するための最良の実施](eop/best-practices-for-configuring-eop.md)
...
### [Backscatter メッセージと EOP](backscatter-messages-and-eop.md)
...
### [メール フロー ルールを使用してバルク メールのフィルター処理を設定する](use-transport-rules-to-configure-bulk-email-filtering.md)
...
### [Office 365 でのメール フロー インテリジェンス](mail-flow-intelligence-in-office-365.md)
## メールボックスの保留
### [訴訟ホールドを作成する](create-a-litigation-hold.md)
### [電子情報開示のために Bcc および展開された配布リスト グループの受信者を保存する](preserve-bcc-and-expanded-distribution-group-recipients-for-ediscovery.md)
...
### [障碍があるユーザーの為の補助機能](eop/accessibility-for-people-with-disabilities.md)
### [Office 365 へのメール送信](sending-mail-to-office-365.md)
### [ユーザー以外へのサービス](services-for-non-customers.md)
