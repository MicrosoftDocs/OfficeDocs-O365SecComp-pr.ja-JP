...
|**状態** <br/> | 電子メールの送信日。サイトドキュメントの変更された日付。 <br/> |
...
|**サイズ** <br/> | ファイルのサイズ (KB 単位)。 <br/> |
|**subjecttitle** <br/> | 電子メールの件名。サイトドキュメントのタイトル。 <br/> |
|**Bcc** <br/> | 電子メールの Bcc フィールド。 <br/> |
|**Cc** <br/> | 電子メールの Cc フィールド。 <br/> |
|**全員** <br/> | 電子メールスレッド内のすべての参加者の電子メールアドレス (存在しないリンクを含む)。 <br/> |
|**時** <br/> | 電子メールが受信された日付。 <br/> |
|**全員** <br/> | [宛先]、[Cc]、または [Bcc] フィールドに含まれている電子メールの受信者。 <br/> |
|**送信者** <br/> | 電子メールの送信者。 <br/> |
|**lastmodifieddate** <br/> | サイトドキュメントの最終更新日。 <br/> |
|**送信** <br/> | 電子メールの送信日。 <br/> |
|**宛先** <br/> | 電子メールの宛先フィールドに記載されている受信者。 <br/> |
