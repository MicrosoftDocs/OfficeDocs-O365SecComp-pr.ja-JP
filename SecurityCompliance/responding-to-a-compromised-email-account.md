...
ユーザーが上記の兆候のいずれかを報告してきた場合は、詳しい調査を実施する必要があります。Office 365 セキュリティ/コンプライアンス センターと Azure ポータルに、侵害が疑われるユーザー アカウントの活動を調査するためのツールが用意されています。
...
1. グローバル管理者アカウントで Office 365 管理センターにサインインして、**[アクティブなユーザー]** を開きます。
