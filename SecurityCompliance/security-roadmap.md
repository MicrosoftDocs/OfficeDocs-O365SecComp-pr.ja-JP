...
|ID およびアクセス管理  <br/> | •ポリシーおよび運用プロセスを調整します。  <br/>  • Azure AD Id 保護を使用して、内部の脅威を特定します。  |
|情報保護  <br/> | 情報保護ポリシーを調整する:  <br/>  • Microsoft 365 および Office 365 の機密ラベルとデータ損失防止 (DLP)、または Azure Information Protection。  <br/>  • Cloud App Security ポリシーとアラート。  <br/> |
