...
- 監査対象アクティビティがユーザーまたは管理者によって実行されると、監査レコードが生成され、組織の Office 365 監査ログに格納されます。監査レコードの保持期間 (および監査ログで検索可能な期間) は、Office 365 サブスクリプション、具体的には、特定のユーザーに割り当てられたライセンスの種類によって異なります。
     ...
     - **Office 365 E5** -監査レコードも90日保持されます。 1年間の監査記録の保持は、E3 ライセンスと Office 365 Advanced コンプライアンスアドオンライセンスを持つユーザーおよびユーザーに対して、最終的には E5 に利用可能になる可能性があります。

        > [!NOTE]
        > E5 組織の監査レコード (または、高度なコンプライアンスアドオンライセンスを持つ E3 組織のユーザー) の1年間の保持期間用のプライベートプレビュープログラムが、新しい登録に閉じられました。 この記事は、1年間の保存期間が公開プレビューで利用可能な場合、または一般提供をリリースしている場合に更新されます。
...
Microsoft Flow のアクティビティについては、監査ログを検索できます。 これらのアクティビティには、フローの作成、編集、削除、およびフローのアクセス許可の変更が含まれます。 フローアクティビティの監査の詳細については、「 [Security _AMP_ コンプライアンスセンターで利用可能になった Microsoft Flow audit audit events](https://flow.microsoft.com/blog/security-and-compliance-center)」を参照してください。
...
- **Office 365 E5** -監査レコードも90日保持されます。 1年間の監査記録の保持は、E3 ライセンスと Office 365 Advanced コンプライアンスアドオンライセンスを持つユーザーおよびユーザーに対して、最終的には E5 に利用可能になる可能性があります。
     ...
     > [!NOTE]
     > 前述したように、E5 組織 (高度なコンプライアンスアドオンライセンスを持つ E3 組織) の監査レコードの1年間の保持期間のプライベートプレビュープログラムは、新しい登録に対して閉じられています。 この記事は、1年間の保存期間が公開プレビューで利用可能な場合、または一般提供をリリースしている場合に更新されます。

また、監査レコードの保持期間の期間は、ユーザーごとのライセンスに基づいていることにも注意してください。 たとえば、組織内のユーザーに Office 365 E3 または E5 ライセンスが割り当てられている場合、そのユーザーが実行したアクティビティの監査レコードは、90日間保持されます。
