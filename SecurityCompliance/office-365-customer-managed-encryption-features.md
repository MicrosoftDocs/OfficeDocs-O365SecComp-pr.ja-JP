...
- [DMARC を使用して Office で電子メールを検証する365](https://https://docs.microsoft.com/office365/SecurityCompliance/use-dmarc-to-validate-email)
