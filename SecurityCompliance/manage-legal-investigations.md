...
組織には、組織内の特定の役員または他の従業員に関連する訴訟に対応する理由が多数あります。これにより、電子メール、ドキュメント、インスタントメッセージの会話、ユーザーが毎日の作業タスクで使用したその他のコンテンツの場所についての詳細な調査をすばやく見つけて保持することができます。Office 365 セキュリティ&amp;コンプライアンスセンターの電子情報開示ケースツールを使用すると、このような他の多くの操作を実行できます。
...
コンテンツ検索シナリオのスクリプトを記載した前のセクションと同様に、電子情報&amp;開示ケースの管理に役立つセキュリティコンプライアンスセンターの PowerShell スクリプトも作成しました。
...
Office 365 Advanced ediscovery は、前のセクションで説明したコンテンツ検索および電子情報開示機能に基づいて構築されます。電子情報開示ケースを作成し、保管担当者の場所を保留にして、ケースに応答する可能性があるデータを収集したら、テキスト分析、machine learning、および高度な予測コーディング機能を使用して、さらにデータを分析することができます。情報.これにより、組織は、多数の電子メールメッセージ、ドキュメント、およびその他の種類のデータを簡単に処理して、特定のケースに関連する可能性が最も高いアイテムを見つけることができます。また、 &amp;コンプライアンスセンター内で同じケースをシームレスに管理できるように、統合されたケース管理と高度な電子情報開示を行いました。
...
- セキュリティ&amp; /コンプライアンスセンターを使用して、ケースを作成し、電子情報開示のアクセス許可を割り当て、ケースメンバーを追加することで、高度な電子情報開示の[ユーザーおよびケースをセットアップ](set-up-users-and-cases-in-advanced-ediscovery.md)する 
...
### <a name="set-up-relevance-training"></a>関連性トレーニングの設定
