...
ここでは、社内ユーザー用にクラウドベースのメールボックスを設定するための要件と制限事項について説明します。
...
- プライマリメールボックスが社内組織内にあるユーザーには、Microsoft Teams のライセンスと Exchange Online プラン1のライセンスが割り当てられている必要があります。
...
エンジニアリングの変更が行われた後、Microsoft サポートは展開の推定日付を送信します。 通常、サポート要求を送信した後、展開プロセスには 2 ~ 3 週間かかります。 
