...
- ユーザーが Outlook Web アプリケーション (OWA) を使用している、2018年 6 月年 ATP の安全なリンクは、元の Url をレンダリングし、書き換えられた Url を表示しません。電子メールの元のリンクを表示するのにはこれができます。(この機能はまだ Outlook クライアント アプリケーションを使用します。)
